...
public class CustomEntityResponseHandler extends ResponseEntityExceptionHandler {
    ...
    public final ResponseEntity<ExcpetionResponse> handleAllException(Exception ex, WebRequest request) {
        ...
        public final ResponseEntity<ExcpetionResponse> handleBadRequestException (Exception ex, WebRequest request){
            ExcpetionResponse response = new ExcpetionResponse(
                    new Date(),
                    ex.getMessage(),
                    request.getDescription(false));
